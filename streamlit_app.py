...
24UEC311	ELECTRONIC DEVICES AND CIRCUITS 	L T P C
2 0 2 3
Nature of Course: Theory with Practical	PCC
Prerequisite(s): Physics for Electronics Engineering , Circuit Analysis
Course Objectives: Enable the students to
⮚	Understand the structure, operation, and characteristics of semiconductor devices and apply them in circuits such as rectifiers and voltage regulators
⮚	Analyze and design biasing circuits of BJT and MOSFET amplifiers
⮚	Design and analyze multistage and differential amplifiers with focus on gain and frequency response.
⮚	Understand the principles of feedback amplifiers and oscillators and design stable oscillation circuits.
⮚	Design and evaluate power amplifier circuits and DC/DC converters.
Course Contents:
 UNIT I	SEMICONDUCTOR DEVICES	CO1	6
 PN junction diode, Zener diode as a Regulator, BJT, JFET, MOSFET-diffusion and transition capacitance - Rectifiers – Half Wave and Full Wave Rectifier.
 UNIT II	AMPLIFIERS	CO2	6
 Biasing methods for BJT, Small Signal Model– Analysis of CE, CB, CC amplifiers and Biasing methods for JFET, Small Signal Model– Analysis of CS, CG and Source follower.
 UNIT  III	MULTISTAGE AMPLIFIERS AND DIFFERENTIAL AMPLIFIER	CO3	6
Cascade amplifier, Differential amplifier – Common mode and Difference mode analysis, Tuned amplifiers – Gain and frequency response – Neutralization methods.
 UNIT IV	FEEDBACK AMPLIFIERS AND OSCILLATORS	CO4	6
Advantages of negative feedback – Voltage / Current, Series, Shunt feedback Amplifiers – positive feedback–Condition for oscillations, phase shift – Wien bridge, Hartley, Colpitts and Crystal oscillators
 UNIT V	POWER AMPLIFIERS AND DC/DC CONVERTERS	CO5	6
Power amplifiers- Class A-Class B-Class AB-Class C ,DC/DC convertors – Buck, Boost, Buck-Boost 
Total Hours:	30

 PRACTICAL EXERCISES – List of Experiments
1.	Design and implement Zener Diode Voltage Regulator	CO1
2.	Design and implement rectifier circuits  	CO1
3.	Design BJT / JFET based amplifier and analyze its frequency response.
CO2
4.	Design a differential amplifier and measure common-mode and differential outputs and assess the performance of the amplifier by calculating and interpreting CMRR. 	CO3
5.	Design a Wien Bridge Oscillator using BJT, verify its frequency of oscillation, and analyze startup conditions and amplitude stabilization.	CO4
6.	Design and implement Class A Power amplifier	CO5
Practical Hours:	30
Total Hours:	60
...
CO1	Analyze the operation and V-I characteristics of semiconductor devices and their applications 
CO2	Design and evaluate biasing techniques of single-stage BJT and FET amplifiers.
CO3	Design and analyze multistage and differential amplifiers, including their frequency response and gain.
CO4	Analyze feedback amplifier configurations and design oscillators like Wien bridge, Hartley, and Colpitts.
CO5	Design power amplifier circuits and DC/DC converters with MOSFETs .

Text Books:
1	V.K. Mehta and Rohit Mehta, Principles of Electronic Devices & Circuits S. Chand Publishing 2023 Reprint
2	Thomas L. Floyd and David M. Buchla, Electronic Devices Pearson 11th Edition 2022
3	Robert L. Boylestad and Louis Nashelsky, “Electronic Devices and Circuit Theory”, Fourteenth Edition, Pearson, 2023
4	Adel .S. Sedra, Kenneth C. Smith, "Micro Electronic Circuits", Oxford University Press, 7 th Edition, 2014.
Reference Books:
1	Thomas L. Floyd and David M. Buchla, “Electronics Fundamentals: Circuits, Devices and Applications”, Eighth Edition, Pearson, 2018
2	David A. Bell, "Electronic Devices and Circuits", Oxford Higher Education press, 5 th Edition, 2010.
3	Marian Kazimierczuk and Ali Aminian, “Electronic Devices: A Design Approach”, Second Edition, Pearson Prentice Hall, 2014
Online Resources:
1	https://archive.nptel.ac.in/courses/108/108/108108112/
2	https://archive.nptel.ac.in/courses/117/103/117103063/
3	https://onlinecourses.nptel.ac.in/noc21_ee55/preview
4	https://be-iitkgp.vlabs.ac.in/List%20of%20experiments.html
...
CO4	3	2	2	1	2	-	-	-	-	-	-	2	-	-
CO5	3	2	2	1	3	-	-	-	-	-	-	2	1	-
Correlation levels 1, 2 and 3 are as defined below:   1 - Slight 2 – Moderate 3 - Substantial (High)
